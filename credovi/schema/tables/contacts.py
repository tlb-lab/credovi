...
contacts = Table('contacts', metadata,
                 ...
                 Column('is_secondary', Boolean(create_constraint=False), DefaultClause('false'), nullable=False),
...
comments = {
    ...
    "columns":
    {
        ...
        "is_secondary": "True if the contact is secondary, i.e. if a third atom is between the two atoms.",
        "is_covalent": "",
        "is_vdw_clash": "",
        "is_vdw": "",
        "is_proximal": "",
