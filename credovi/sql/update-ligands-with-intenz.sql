...
CREATE INDEX idx_ligand_to_chebi_id_chebi_id  ON ligand_to_chebi_id USING btree (chebi_id) WITH (FILLFACTOR=100);
CREATE INDEX idx_ligand_to_chebi_id_ligand_id ON ligand_to_chebi_id USING btree (ligand_id) WITH (FILLFACTOR=100);
